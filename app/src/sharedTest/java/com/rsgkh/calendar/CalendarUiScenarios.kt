...
abstract class CalendarUiScenarios {
    ...
    @Test fun recurringMonthlyPreviewSaveEditAndDeleteUseTheOriginalSeries() {
        ...
        compose.onNodeWithText("Save").performScrollTo().performClick()
        compose.onAllNodesWithText("Updated series").onFirst().performClick()
    ...
    @Test fun dateGridOpensDetailsAndReturnsFromEventDetails() {
        ...
        compose.onNodeWithText("Thursday, September 10, 2026").assertIsDisplayed()
        ...
        compose.onNodeWithText("Close").performClick()
        compose.onNodeWithText("Date details").assertIsDisplayed()
        compose.onNodeWithText("Thursday, September 24, 2026").assertIsDisplayed()
        compose.onNodeWithText("Close").performClick()
